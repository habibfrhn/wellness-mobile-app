  ...
  return (
    <>
      ...
      <View style={[styles.timeRow, compact && styles.timeRowCompact]}>
        <Text style={[styles.timeText, compact && styles.timeTextCompact]}>{formatTime(current)}</Text>
        <Text style={[styles.timeText, compact && styles.timeTextCompact]}>{formatTime(duration)}</Text>
      </View>
    </>
  );
}
