export const id = {
  ...
  common: {
    ...
    weakPasswordBody: "Gunakan 12–128 karakter dengan kombinasi huruf besar, huruf kecil, angka, dan simbol.",
    weakPasswordLongBody: "Kata sandi terlalu panjang. Gunakan maksimal 128 karakter.",
  ...
  signup: {
    ...
    passwordPlaceholder: "12–128 karakter",
  ...
  reset: {
    ...
    placeholderNew: "12–128 karakter",
  ...
  admin: {
    ...
    dashboardSubtitle: "Data usage inti untuk keputusan produk MVP.",
    refreshCta: "Refresh",
    signOutCta: "Logout",
    ...
    productSignalsSubtitle: "Metrik inti yang tervalidasi dan stabil.",
    homeSleepClickLabel: "Klik “Mulai Tidur”",
    audioUsageTitle: "Pemakaian audio per konten",
    audioUsageSubtitle: "Audio yang dipilih, dimulai, selesai, dan ditinggalkan.",
    audioLabel: "Audio",
    ...
    tailoredUsageSubtitle: "Volume penggunaan per mode tailored session.",
    tailoredCalmMindLabel: "Calm Mind",
    tailoredReleaseAcceptLabel: "Release & Accept",
    tailoredSessionModeLabel: "Mode",
    tailoredSelectionsLabel: "Selected",
    tailoredStartsLabel: "Started",
    tailoredCompletesLabel: "Completed",
    monthlyComparisonTitle: "Perbandingan bulanan",
    monthlyComparisonSubtitle: "Bandingkan tren bulan berjalan vs bulan sebelumnya.",
    monthLabel: "Bulan",
    monthlyHomeSleepLabel: "Home sleep clicks",
    monthlyAudioStartsLabel: "Audio starts",
    monthlyAudioCompletesLabel: "Audio completes",
    monthlyTailoredStartsLabel: "Tailored starts",
    monthlyTailoredCompletesLabel: "Tailored completes",
