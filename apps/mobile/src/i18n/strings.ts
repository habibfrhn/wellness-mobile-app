export const id = {
  ...
  verify: {
    ...
    initialHelperSignup: "Tautan verifikasi awal masih berlaku. Cek inbox lalu folder Spam/Promosi sebelum kirim ulang.",
    initialHelperLogin: "Akun Anda belum terverifikasi. Gunakan tautan terbaru di inbox atau folder Spam/Promosi.",
    changeEmail: "Ganti email",
    backToLogin: "Kembali ke masuk",
    helpSignup: "Kami baru saja mengirim tautan verifikasi. Tautan biasanya aktif hingga sekitar 1 jam.",
    helpLogin: "Login dibatasi sampai email terverifikasi demi keamanan akun.",
