export const id = {
  ...
  admin: {
    ...
    dashboardSubtitle: "Metrik perilaku pengguna untuk validasi produk.",
    refreshCta: "Refresh",
    signOutCta: "Logout",
    ...
    totalAudioPlays: "Total audio plays",
    tailoredCompletion: "Tailored completion",
    funnelSignupConversion: "Signup conversion",
    audioCompletionVsAbandonment: "Audio complete / abandon",
    audioTableTitle: "Audio completion vs abandonment",
    monthly12mTitle: "12-month monthly trend",
    funnelTitle: "Landing funnel",
    funnelPageView: "Landing page view",
    funnelCta: "CTA click",
    funnelSignupStart: "Signup start",
    funnelSignupComplete: "Signup complete",
