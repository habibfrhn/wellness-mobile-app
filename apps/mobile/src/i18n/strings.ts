export const id = {
  ...
  home: {
    ...
    primaryCardTitle: "Rencanakan sesi tidur malam ini",
    primaryCardBody: "Kami akan menyesuaikan panduan dan suara yang paling cocok untuk kamu malam ini.\nKamu hanya perlu bersiap untuk beristirahat.",
