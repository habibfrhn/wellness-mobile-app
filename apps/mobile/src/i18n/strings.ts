export const id = {
  ...
  signup: {
    ...
    passwordRuleTitle: "Kata sandi harus memiliki:",
    passwordRuleMin: "Minimal 8 karakter",
    passwordRuleMax: "Maksimal 64 karakter",
    passwordRuleUppercase: "Minimal 1 huruf besar (A-Z)",
    passwordRuleLowercase: "Minimal 1 huruf kecil (a-z)",
    passwordRuleNumber: "Minimal 1 angka (0-9)",
    passwordRuleSpecial: "Minimal 1 simbol (contoh: !@#$%)",
