export const id = {
  ...
  verify: {
    ...
    resendSuccessInline: "Link verifikasi berhasil dikirim.",
    resendHelperRateLimited: "Belum bisa kirim ulang. Cek inbox/spam dulu, lalu coba lagi setelah jeda selesai.",
    resendHelperLinkStillValid: "Link verifikasi masih valid. Cek inbox, Spam, atau Promosi lalu klik link tersebut.",
    helpSignup: "Klik link verifikasi di email Anda, lalu masuk.",
    helpLogin: "Akun belum terverifikasi. Klik link verifikasi di email Anda, lalu masuk.",
  },

  forgot: {
    title: "Lupa kata sandi",
    subtitle: "Kami akan mengirim link untuk mengatur ulang kata sandi lewat email.",
    emailLabel: "Email",
    emailPlaceholder: "anda@email.com",
    ...
    successTitle: "Jika email terdaftar, link terkirim",
    successBody: "Jika email tersebut terdaftar, kami mengirim link reset kata sandi.",
    failedTitle: "Gagal mengirim link reset",
    failedBody: "Pengiriman link reset gagal. Periksa konfigurasi auth redirect URL dan coba lagi.",
  ...
  admin: {
    ...
    loginSubtitle: "Login khusus admin untuk melihat metrik MVP.",
    ...
    dashboardSubtitle: "Validasi produk berbasis perilaku pengguna nyata.",
    refreshCta: "Refresh",
    signOutCta: "Logout",
    ...
    audioUsageSubtitle: "Fokus ke audio yang dipilih, dimulai, selesai, dan ditinggalkan.",
    audioLabel: "Audio",
    audioClicksLabel: "Clicks",
    audioStartsLabel: "Starts",
    audioCompletesLabel: "Completes",
